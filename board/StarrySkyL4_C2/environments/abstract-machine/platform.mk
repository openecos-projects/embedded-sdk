...
$(error 错误：SDK 中的 ysyxsoc 平台只允许通过 StarrySkyL4_C2 AbstractMachine 环境构建)
endif
ifneq ($(AM_BOARD_ID),starrysky-l4-c2)
$(error 错误：AbstractMachine 环境当前只支持 starrysky-l4-c2，收到 $(AM_BOARD_ID))
endif
...
INC_PATH += $(ECOS_SDK_HOME)/hal/sys_uart \
			...
			$(ECOS_SDK_HOME)/components/soc/ysyx-2512-1/include \
			$(AM_GENERATED_DIR)
