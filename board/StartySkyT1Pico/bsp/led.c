...
#define STARTYSKY_T1_PICO_LED_COUNT 1u
...
static const led_gpio_t led_gpios[STARTYSKY_T1_PICO_LED_COUNT] = {
    [BSP_LED_0] = { ECOS_GPIO_PORT_3, 4u },
};
...
ecos_err_t bsp_led_init(void)
{
    ...
    const led_gpio_t *gpio = &led_gpios[BSP_LED_0];
    int result;
