...
$(error 错误：SDK 中的 ysyxsoc 平台只允许通过 StarrySkyL4_C1 AbstractMachine 环境构建)
endif
ifneq ($(AM_BOARD_ID),starrysky-l4-c1)
$(error 错误：AbstractMachine 环境当前只支持 starrysky-l4-c1，收到 $(AM_BOARD_ID))
endif
