...
LDFLAGS += -DCONFIG_LINK_TARGET_FLASH -D_pmem_start=0x30000000 -D_entry_offset=0x0
CFLAGS += -DCONFIG_LINK_TARGET_FLASH -D_pmem_start=0x30000000 -D_entry_offset=0x0
endif

ifdef CONFIG_LINK_TARGET_RAM
LDFLAGS += -DCONFIG_LINK_TARGET_RAM -D_pmem_start=0x80000000 -D_entry_offset=0x0
CFLAGS += -DCONFIG_LINK_TARGET_RAM -D_pmem_start=0x80000000 -D_entry_offset=0x0
endif
