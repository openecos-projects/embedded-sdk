# ysyx-2512-1 SoC Target

`ysyx-2512-1` 是星空 L4C1/L4C2 板卡使用的 Target/SoC。本目录统一保存原先位于
...
Board 清单负责描述 Board ID、板级资源和默认 profile，并将 `starrysky-l4-c1`
...
python3 "$ECOS_SDK_HOME/tools/ecos.py" --sdk "$ECOS_SDK_HOME" \
    project create hello --board starrysky-l4-c1
cd hello
ecos build
```
