...
#define YSYX_2512_2_PWM_COUNT 2u
...
static uint8_t pwm_initialized[YSYX_2512_2_PWM_COUNT];
static uint32_t pwm_period_ticks[YSYX_2512_2_PWM_COUNT];

static int pwm_id_is_valid(hal_pwm_id_t pwm)
{
    return pwm < YSYX_2512_2_PWM_COUNT;
}
...
{
    return (int)YSYX_2512_2_PWM_COUNT;
}
