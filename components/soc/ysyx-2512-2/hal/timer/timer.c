...
#define YSYX_2512_2_TIMER_COUNT 4u
...
static uint8_t timer_initialized[YSYX_2512_2_TIMER_COUNT];

static int timer_id_is_valid(hal_timer_id_t timer)
{
    return timer < YSYX_2512_2_TIMER_COUNT;
}
...
{
    return (int)YSYX_2512_2_TIMER_COUNT;
}
