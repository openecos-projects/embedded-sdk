# ysyx-2512-2 SoC Target

`ysyx-2512-2` 是星空 L4C3 板卡使用的 Target/SoC。本目录统一保存原先位于
...
Board 清单负责描述 Board ID、板级资源和默认 profile，并将 `starrysky-l4-c3`
...
python3 "$ECOS_SDK_HOME/tools/ecos.py" --sdk "$ECOS_SDK_HOME" \
    project create hello --board starrysky-l4-c3
cd hello
ecos build
```
