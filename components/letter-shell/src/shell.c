...
static const char *shellText[] =
{
    ...
    [SHELL_TEXT_INFO] =
        "\r\n""\x1b[32m"
        " .oooooo..o     .                                            .oooooo..o oooo                    ""\r\n"
        "d8P'    `Y8   .o8                                           d8P'    `Y8 `888                    ""\r\n"
        "Y88bo.      .o888oo  .oooo.   oooo d8b oooo d8b oooo    ooo Y88bo.       888  oooo  oooo    ooo ""\r\n"
        " `\"Y8888o.    888   `P  )88b  `888\"\"8P `888\"\"8P  `88.  .8'   `\"Y8888o.   888 .8P'    `88.  .8'  ""\r\n"
        "     `\"Y88b   888    .oP\"888   888      888       `88..8'        `\"Y88b  888888.      `88..8'   ""\r\n"
        "oo     .d8P   888 . d8(  888   888      888        `888'    oo     .d8P  888 `88b.     `888'    ""\r\n"
        "8\"\"88888P'    \"888\" `Y888\"\"8o d888b    d888b        .8'     8\"\"88888P'  o888o o888o     .8'     ""\r\n"
        "                                                .o..P'                              .o..P'      ""\r\n"
        "                                                `Y8P'                               `Y8P'       ""\r\n"                                                                                      
        "\r\n"
        "Build:             "__DATE__" "__TIME__"\r\n"
        "Shell Version:     "SHELL_VERSION"\r\n"
        "Firmware Version:  "CONFIG_FIRMWARE_VERSION"\r\n"
        "Inspired By:       ECOS-SIG & Letter-Shell & FINALx\r\n""\x1b[0m",
...
unsigned short shellWriteString(Shell *shell, const char *string)
{
    ...
    unsigned short ret = shell->write((char *)string, count);
    return ret;
}
...
int shellGetVarValue(Shell *shell, ShellCommand *command)
{
    ...
    case SHELL_TYPE_VAR_NODE: {
        int (*func)(void *) = (int (*)(void *))(((ShellNodeVarAttr *)command->data.var.value)->get);
    ...
    else
    {
        ...
        case SHELL_TYPE_VAR_NODE:
            if (((ShellNodeVarAttr *)command->data.var.value)->set)
            {
                ...
                {
                    int (*func)(int) = (int (*)(int))(((ShellNodeVarAttr *)command->data.var.value)->set);
                    func(value);
                }
            }
            break;
...
unsigned int shellRunCommand(Shell *shell, ShellCommand *command)
{
    ...
    if (command->attr.attrs.type == SHELL_TYPE_CMD_MAIN)
    {
        ...
        int (*func)(int, char **) = (int (*)(int, char **))(command->data.cmd.function);
