...
_ecos_completions() {
    ...
    templates="asm_hello asm_gpio clint gpio gpio_interrupt hello i2c_eeprom i2c_scan i2c_sgp30 isram minesweeper plic pwm qspi_psram sdram spi_st7735 spi_st7735_clock spi_st7735_donut spi_st7789 timer timer_interrupt list"
