...
class StartySkyT1CapabilityTest(unittest.TestCase):
    def test_board_bound_examples_remain_unavailable(self):
        expected_capabilities = {
            "blink": "led",
            "gpio-basic": "gpio-demo",
            "pwm-basic": "pwm",
        }
...
class StartySkyT1BuildTest(unittest.TestCase):
    ...
    def test_hello_build_uses_cl1_uart_and_t1_console(self):
        ...
        for source in (
            ...
            "board/StartySkyT1/bsp/console.c",
